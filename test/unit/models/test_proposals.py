...
def test_proposal_is_valid(proposal):
    ...
    # binary gibberish
    proposal.name = energilib.deserialise('')
    assert proposal.is_valid() is False
    ...
    # ============================================================
    # ensure proposal can't request negative energi
    # ============================================================
...
def test_approved_and_ranked(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_energid(energid, item)
