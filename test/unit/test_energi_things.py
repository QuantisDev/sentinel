...
def test_valid_energi_address():
    from energilib import is_valid_energi_address

    main = valid_energi_address()
    test = valid_energi_address('testnet')

    assert is_valid_energi_address(main) is True
    assert is_valid_energi_address(main, 'mainnet') is True
    ...
    assert is_valid_energi_address(test, 'testnet') is True


def test_invalid_dash_address():
    from energilib import is_valid_energi_address

    main = invalid_energi_address()
    test = invalid_energi_address('testnet')
...
def test_deterministic_masternode_elections(current_block_hash, mn_list):
    from energilib import elect_mn
...
def test_hash_function():
    ...
    hex_hash = "%x" % energilib.hashit(sb_data_hex)
